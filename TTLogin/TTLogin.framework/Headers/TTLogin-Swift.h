...
SWIFT_CLASS("_TtC7TTLogin10TTLAccount")
@interface TTLAccount : NSObject
- (NSString * _Nonnull)getToken;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end

typedef SWIFT_ENUM(NSInteger, TTLAppVersion) {
  TTLAppVersionOk = 0,
  TTLAppVersionUpgradeRecommended = 1,
  TTLAppVersionUpgradeNow = 2,
};

@class NSError;

SWIFT_PROTOCOL("_TtP7TTLogin11TTLCallback_")
...
@interface UIDevice (SWIFT_EXTENSION(TTLogin))
@end
